    ...
    <div className="layout-container">
        ...
        <aside className="sidebar">
            ...
            <nav className="side-nav">
                ...
                <a href="05_engineering.html" className="nav-item active">
        ...
        <main className="content-area">
            <div className="breadcrumb">
                <a href="index.html"><i className="fas fa-home"></i> 首頁</a> <span className="divider">&gt;</span> <span className="current">治水與工程誌</span>
            </div>

            <div className="inner-hero">
                <div className="hero-text">
                    <h1 className="serif title-large">治水與工程誌</h1>
                    <h2 className="subtitle">治水建設 · 守護安全</h2>
                    <p>回顧治水工程與河川整治歷程，展現水利建設如何守護人民與流域安全。</p>
                </div>
                <div className="hero-image">
                    <img src="https://images.unsplash.com/photo-1505322022379-7c3353ee6291?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="治水與工程誌" />
                </div>
            </div>
