    ...
    <div className="layout-container">
        ...
        <aside className="sidebar">
            ...
            <nav className="side-nav">
                ...
                <a href="01_story.html" className="nav-item active">
        ...
        <main className="content-area">
            <div className="breadcrumb">
                <a href="index.html"><i className="fas fa-home"></i> 首頁</a> <span className="divider">&gt;</span> <span className="current">流域故事誌</span>
            </div>

            <div className="inner-hero">
                <div className="hero-text">
                    <h1 className="serif title-large">流域故事誌</h1>
                    <h2 className="subtitle">記錄三川 · 人與河的故事</h2>
                    <p>探索三大流域的人文歷史、地方記憶與水文故事，傳承世代的河川文化。</p>
                </div>
                <div className="hero-image">
                    <img src="https://images.unsplash.com/photo-1544644181-1484b3fdfc62?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="流域故事誌" />
                </div>
            </div>
