            ...
            <div className="logo">
                <div className="logo-icon">
                    <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="50" cy="50" r="45" fill="#00a0e9" opacity="0.2"/>
                        <path d="M20 50 Q 50 20 80 50 T 80 80 Q 50 100 20 80 T 20 50" fill="url(#grad2)"/>
                        <path d="M30 60 Q 50 40 70 60" stroke="#fff" stroke-width="4" stroke-linecap="round"/>
                        <path d="M40 75 Q 50 60 60 75" stroke="#fff" stroke-width="4" stroke-linecap="round"/>
                        <defs>
        ...
        <main className="content-area">
            ...
            <div className="inner-hero">
                <div className="hero-text">
                    ...
                    <h2 className="subtitle">記錄三川 · 人與河的故事</h2>
                    <p>實地走訪河川現場，記錄踏查足跡與自然地景，發現流域之美。</p>
                </div>
                <div className="hero-image">
                    <img src="https://images.unsplash.com/photo-1551632811-561732d1e306?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="踏查" />
                </div>
            </div>
