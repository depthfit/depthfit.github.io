    ...
    <div className="layout-container">
        ...
        <aside className="sidebar">
            ...
            <nav className="side-nav">
                ...
                <a href="04_ecology.html" className="nav-item active">
        ...
        <main className="content-area">
            <div className="breadcrumb">
                <a href="index.html"><i className="fas fa-home"></i> 首頁</a> <span className="divider">&gt;</span> <span className="current">三川生態誌</span>
            </div>

            <div className="inner-hero">
                <div className="hero-text">
                    <h1 className="serif title-large">三川生態誌</h1>
                    <h2 className="subtitle">生態多樣 · 永續共生</h2>
                    <p>介紹流域生態環境與生物多樣性，記錄珍貴物種與棲地，守護自然的永續未來。</p>
                </div>
                <div className="hero-image">
                    <img src="https://images.unsplash.com/photo-1588614959060-4d144f28b207?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="三川生態誌" />
                </div>
            </div>
