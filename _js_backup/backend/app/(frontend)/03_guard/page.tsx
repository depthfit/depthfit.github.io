    ...
    <div className="layout-container">
        ...
        <aside className="sidebar">
            ...
            <nav className="side-nav">
                ...
                <a href="03_guard.html" className="nav-item active">
        ...
        <main className="content-area">
            <div className="breadcrumb">
                <a href="index.html"><i className="fas fa-home"></i> 首頁</a> <span className="divider">&gt;</span> <span className="current">守護行動誌</span>
            </div>

            <div className="inner-hero">
                <div className="hero-text">
                    <h1 className="serif title-large">守護行動誌</h1>
                    <h2 className="subtitle">守護家園 · 共同行動</h2>
                    <p>記錄守護河川的行動與力量，展現志工、社區與民眾共同守護家園的成果。</p>
                </div>
                <div className="hero-image">
                    <img src="https://images.unsplash.com/photo-1594732832278-abd644401426?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="守護行動誌" />
                </div>
            </div>
