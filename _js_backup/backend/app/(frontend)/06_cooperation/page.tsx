    ...
    <div className="layout-container">
        ...
        <aside className="sidebar">
            ...
            <nav className="side-nav">
                ...
                <a href="06_cooperation.html" className="nav-item active">
        ...
        <main className="content-area">
            <div className="breadcrumb">
                <a href="index.html"><i className="fas fa-home"></i> 首頁</a> <span className="divider">&gt;</span> <span className="current">公私協力誌</span>
            </div>

            <div className="inner-hero">
                <div className="hero-text">
                    <h1 className="serif title-large">公私協力誌</h1>
                    <h2 className="subtitle">公私協力 · 共創流域價值</h2>
                    <p>記錄公私協力合作成果，串聯企業、社區與民間力量，共創流域永續價值。</p>
                </div>
                <div className="hero-image">
                    <img src="https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="公私協力誌" />
                </div>
            </div>
